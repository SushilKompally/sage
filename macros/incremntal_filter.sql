...
{% macro incremental_filter(
  ...
  {% set source_ts = source_ts_col or var('source_record_creation_column', 'WHENMODIFIED') %}
  {% set target_ts = target_ts_col or var('silver_target_timestamp_col', 'WHENMODIFIED') %}
